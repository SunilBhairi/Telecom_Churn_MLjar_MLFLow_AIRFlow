...
y_test = pd.read_csv('/Users/I353375/Downloads/MLOps/airflow/Telecom_Churn/y_test.csv')  # Actual targetvalues
OUTPUT_DIR = "/Users/I353375/Downloads/MLOps/airflow/"

def telecom_load_model_and_predict():
    ...
    # --- Save to CSV ---
    output_file = os.path.join(OUTPUT_DIR, f"telecom_predictions.csv")
...
if __name__ == "__main__":
    telecom_load_model_and_predict()
