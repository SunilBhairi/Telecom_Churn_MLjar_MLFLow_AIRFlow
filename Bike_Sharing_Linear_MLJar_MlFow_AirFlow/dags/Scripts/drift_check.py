...
# --- Paths ---
baseline_path = '/Users/I353375/Downloads/MLOps/airflow/X_train.csv'
current_path = '/Users/I353375/Downloads/MLOps/airflow/X_test.csv'
report_output_dir = '/Users/I353375/Downloads/MLOps/airflow/reports'
os.makedirs(report_output_dir, exist_ok=True)
timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
report_file_path = os.path.join(report_output_dir, f"data_drift_report_{timestamp}.json")
